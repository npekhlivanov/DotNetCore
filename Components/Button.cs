...
<html lang="en">
  ...
  <title>IotCamera/Button.cs at master · robertsundstrom/IotCamera · GitHub</title>
  ...
  <meta name="request-id" content="CD9C:6F9E:10799BE:1C0470C:5BA3CECE" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="CD9C:6F9E:10799BE:1C0470C:5BA3CECE" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="octolytics-dimension-user_id" content="919580" /><meta name="octolytics-dimension-user_login" content="robertsundstrom" /><meta name="octolytics-dimension-repository_id" content="107713638" /><meta name="octolytics-dimension-repository_nwo" content="robertsundstrom/IotCamera" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="107713638" /><meta name="octolytics-dimension-repository_network_root_nwo" content="robertsundstrom/IotCamera" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/robertsundstrom/IotCamera/blob/master/src/Components/Button.cs" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="107713638" data-scoped-search-url="/robertsundstrom/IotCamera/search" data-unscoped-search-url="/search" action="/robertsundstrom/IotCamera/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=JBXoBkjwQK4KWDjMk99LZKw21ogpVMWq7Z0f5hj0vXmvm+ZMY2Tb7vCmKVzfff0diKIKYBna9+uorAFTKBPQAw=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <a class="HeaderMenu-target text-white no-underline mr-3" href="/login?return_to=%2Frobertsundstrom%2FIotCamera%2Fblob%2Fmaster%2Fsrc%2FComponents%2FButton.cs" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:dropdowns">Sign&nbsp;in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/robertsundstrom/IotCamera/blob/3a81c5527791fc081a13b71955903aaeca75433e/src/Components/Button.cs">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:522528328567672b4790728f8871baba -->

      <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Hzc/28CTcxGvyS7RFKj7eDNHu+iNNY0dw2MRNKowM2323hnaDt8XOtphNWiIOXxmIR/k7TaeC51uc/m7wbJB1Q==" />
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/robertsundstrom/IotCamera/blob/develop/src/Components/Button.cs"
               data-name="develop"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/robertsundstrom/IotCamera/blob/master/src/Components/Button.cs"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
...
<details class="details-reset details-overlay details-overlay-dark lh-default text-gray-dark float-left mr-2" id="blob_contributors_box">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/robertsundstrom/IotCamera/raw/master/src/Components/Button.cs">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/robertsundstrom/IotCamera/blame/master/src/Components/Button.cs">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/robertsundstrom/IotCamera/commits/master/src/Components/Button.cs">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-c">
      ...
      <tr>
        ...
        <td id="LC12" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">public</span> <span class="pl-k">class</span> <span class="pl-en">Button</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC17" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">public</span> <span class="pl-en">Button</span>(<span class="pl-en">GpioPin</span> <span class="pl-smi">gpioPin</span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC26" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">gpioPin</span>.<span class="pl-smi">InputPullMode</span> <span class="pl-k">=</span> <span class="pl-smi">GpioPinResistorPullMode</span>.<span class="pl-smi">PullDown</span>;</td>
      </tr>
      <tr>
        <td id="L27" class="blob-num js-line-number" data-line-number="27"></td>
        <td id="LC27" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">gpioPin</span>.<span class="pl-smi">PinMode</span> <span class="pl-k">=</span> <span class="pl-smi">GpioPinDriveMode</span>.<span class="pl-smi">Input</span>;</td>
      </tr>
      <tr>
        <td id="L28" class="blob-num js-line-number" data-line-number="28"></td>
        <td id="LC28" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">gpioPin</span>.<span class="pl-en">RegisterInterruptCallback</span>(<span class="pl-smi">EdgeDetection</span>.<span class="pl-smi">RisingAndFallingEdges</span>, <span class="pl-smi">OnClick</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC31" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">private</span> <span class="pl-k">void</span> <span class="pl-en">OnClick</span>()</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC33" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">if</span> (<span class="pl-k">!</span><span class="pl-smi">gpioPin</span>.<span class="pl-en">Read</span>())</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC35" class="blob-code blob-code-inner js-file-line">                <span class="pl-k">ulong</span> <span class="pl-smi">interrupt_time</span> <span class="pl-k">=</span> <span class="pl-smi">WiringPi</span>.<span class="pl-en">millis</span>();</td>
      </tr>
      <tr>
        <td id="L36" class="blob-num js-line-number" data-line-number="36"></td>
        <td id="LC36" class="blob-code blob-code-inner js-file-line">                <span class="pl-k">if</span> (<span class="pl-smi">interrupt_time</span> <span class="pl-k">-</span> <span class="pl-smi">last_interrupt_time</span> <span class="pl-k">&gt;</span> <span class="pl-c1">500</span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC38" class="blob-code blob-code-inner js-file-line">                    <span class="pl-smi">last_interrupt_time</span> <span class="pl-k">=</span> <span class="pl-smi">interrupt_time</span>;</td>
      </tr>
      <tr>
        <td id="L39" class="blob-num js-line-number" data-line-number="39"></td>
        <td id="LC39" class="blob-code blob-code-inner js-file-line">                    <span class="pl-smi">Click</span><span class="pl-k">?</span>.<span class="pl-en">Invoke</span>(<span class="pl-k">this</span>, <span class="pl-k">new</span> <span class="pl-en">EventArgs</span>());</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC44" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">public</span> <span class="pl-k">event</span> <span class="pl-en">EventHandler</span>&lt;<span class="pl-en">EventArgs</span>&gt; <span class="pl-en">Click</span>;</td>
      </tr>
      <tr>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/robertsundstrom/IotCamera/blame/3a81c5527791fc081a13b71955903aaeca75433e/src/Components/Button.cs">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.15599s from unicorn-3218182479-bpck4">GitHub</span>, Inc.</li>
