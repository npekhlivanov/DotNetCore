...
<html lang="en">
  ...
  <title>IotCamera/RGBLed.cs at master · robertsundstrom/IotCamera · GitHub</title>
  ...
  <meta name="request-id" content="CD9C:6F9E:107B2D4:1C06AC7:5BA3CEFD" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="CD9C:6F9E:107B2D4:1C06AC7:5BA3CEFD" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="octolytics-dimension-user_id" content="919580" /><meta name="octolytics-dimension-user_login" content="robertsundstrom" /><meta name="octolytics-dimension-repository_id" content="107713638" /><meta name="octolytics-dimension-repository_nwo" content="robertsundstrom/IotCamera" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="107713638" /><meta name="octolytics-dimension-repository_network_root_nwo" content="robertsundstrom/IotCamera" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/robertsundstrom/IotCamera/blob/master/src/Components/RGBLed.cs" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="107713638" data-scoped-search-url="/robertsundstrom/IotCamera/search" data-unscoped-search-url="/search" action="/robertsundstrom/IotCamera/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=k8ji2e4z4R57oQSvMrMPM+pkvFXLZ2RnTfDnhH0WonQYRuyTxad6XoFfFT9+EblKzvBgvfvpViYIwfkxTfHPDg=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <a class="HeaderMenu-target text-white no-underline mr-3" href="/login?return_to=%2Frobertsundstrom%2FIotCamera%2Fblob%2Fmaster%2Fsrc%2FComponents%2FRGBLed.cs" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:dropdowns">Sign&nbsp;in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/robertsundstrom/IotCamera/blob/3a81c5527791fc081a13b71955903aaeca75433e/src/Components/RGBLed.cs">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:fb1a92c9301878c054ca74751914d1b6 -->

      <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="PXZ6lUOnvf/ieZroyEsJ9IPdW5RfcEmWYUl6jdJ3N7XUn1yUjevZ1JfRgVFU2o7qkYUEkeTbzxbMWZICufVFDQ==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/robertsundstrom/IotCamera/blob/develop/src/Components/RGBLed.cs"
               data-name="develop"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/robertsundstrom/IotCamera/blob/master/src/Components/RGBLed.cs"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/robertsundstrom/IotCamera/raw/master/src/Components/RGBLed.cs">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/robertsundstrom/IotCamera/blame/master/src/Components/RGBLed.cs">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/robertsundstrom/IotCamera/commits/master/src/Components/RGBLed.cs">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-c">
      ...
      <tr>
        ...
        <td id="LC12" class="blob-code blob-code-inner js-file-line">    <span class="pl-k">public</span> <span class="pl-k">class</span> <span class="pl-en">RGBLed</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">private</span> <span class="pl-en">GpioPin</span> <span class="pl-smi">redPin</span>;</td>
      </tr>
      <tr>
        <td id="L15" class="blob-num js-line-number" data-line-number="15"></td>
        <td id="LC15" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">private</span> <span class="pl-en">GpioPin</span> <span class="pl-smi">greenPin</span>;</td>
      </tr>
      <tr>
        <td id="L16" class="blob-num js-line-number" data-line-number="16"></td>
        <td id="LC16" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">private</span> <span class="pl-en">GpioPin</span> <span class="pl-smi">bluePin</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC18" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">public</span> <span class="pl-en">RGBLed</span>(<span class="pl-en">GpioPin</span> <span class="pl-smi">redPin</span>, <span class="pl-en">GpioPin</span> <span class="pl-smi">greenPin</span>, <span class="pl-en">GpioPin</span> <span class="pl-smi">bluePin</span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC20" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">this</span>.<span class="pl-smi">redPin</span> <span class="pl-k">=</span> <span class="pl-smi">redPin</span>;</td>
      </tr>
      <tr>
        <td id="L21" class="blob-num js-line-number" data-line-number="21"></td>
        <td id="LC21" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">this</span>.<span class="pl-smi">greenPin</span> <span class="pl-k">=</span> <span class="pl-smi">greenPin</span>;</td>
      </tr>
      <tr>
        <td id="L22" class="blob-num js-line-number" data-line-number="22"></td>
        <td id="LC22" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">this</span>.<span class="pl-smi">bluePin</span> <span class="pl-k">=</span> <span class="pl-smi">bluePin</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC24" class="blob-code blob-code-inner js-file-line">            <span class="pl-en">Initialize</span>();</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC27" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">private</span> <span class="pl-k">void</span> <span class="pl-en">Initialize</span>()</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC29" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">redPin</span>.<span class="pl-smi">PinMode</span> <span class="pl-k">=</span> <span class="pl-smi">GpioPinDriveMode</span>.<span class="pl-smi">Output</span>;</td>
      </tr>
      <tr>
        <td id="L30" class="blob-num js-line-number" data-line-number="30"></td>
        <td id="LC30" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">greenPin</span>.<span class="pl-smi">PinMode</span> <span class="pl-k">=</span> <span class="pl-smi">GpioPinDriveMode</span>.<span class="pl-smi">Output</span>;</td>
      </tr>
      <tr>
        <td id="L31" class="blob-num js-line-number" data-line-number="31"></td>
        <td id="LC31" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">bluePin</span>.<span class="pl-smi">PinMode</span> <span class="pl-k">=</span> <span class="pl-smi">GpioPinDriveMode</span>.<span class="pl-smi">Output</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC33" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">redPin</span>.<span class="pl-en">StartSoftPwm</span>(<span class="pl-c1">0</span>, <span class="pl-c1">225</span>);</td>
      </tr>
      <tr>
        <td id="L34" class="blob-num js-line-number" data-line-number="34"></td>
        <td id="LC34" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">greenPin</span>.<span class="pl-en">StartSoftPwm</span>(<span class="pl-c1">0</span>, <span class="pl-c1">225</span>);</td>
      </tr>
      <tr>
        <td id="L35" class="blob-num js-line-number" data-line-number="35"></td>
        <td id="LC35" class="blob-code blob-code-inner js-file-line">            <span class="pl-smi">bluePin</span>.<span class="pl-en">StartSoftPwm</span>(<span class="pl-c1">0</span>, <span class="pl-c1">225</span>);</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC38" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">public</span> <span class="pl-k">bool</span> <span class="pl-smi">State</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC40" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">get</span> <span class="pl-k">=&gt;</span> <span class="pl-smi">redPin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">&gt;</span> <span class="pl-c1">0</span> <span class="pl-k">||</span> <span class="pl-smi">greenPin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">&gt;</span> <span class="pl-c1">0</span> <span class="pl-k">||</span> <span class="pl-smi">bluePin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">&gt;</span> <span class="pl-c1">0</span>;</td>
      </tr>
      <tr>
        <td id="L41" class="blob-num js-line-number" data-line-number="41"></td>
        <td id="LC41" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">set</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC43" class="blob-code blob-code-inner js-file-line">                <span class="pl-smi">redPin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">=</span> <span class="pl-smi">value</span> <span class="pl-k">?</span> <span class="pl-c1">255</span> <span class="pl-k">:</span> <span class="pl-c1">0</span>;</td>
      </tr>
      <tr>
        <td id="L44" class="blob-num js-line-number" data-line-number="44"></td>
        <td id="LC44" class="blob-code blob-code-inner js-file-line">                <span class="pl-smi">greenPin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">=</span> <span class="pl-smi">value</span> <span class="pl-k">?</span> <span class="pl-c1">255</span> <span class="pl-k">:</span> <span class="pl-c1">0</span>;</td>
      </tr>
      <tr>
        <td id="L45" class="blob-num js-line-number" data-line-number="45"></td>
        <td id="LC45" class="blob-code blob-code-inner js-file-line">                <span class="pl-smi">bluePin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">=</span> <span class="pl-smi">value</span> <span class="pl-k">?</span> <span class="pl-c1">255</span> <span class="pl-k">:</span> <span class="pl-c1">0</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC49" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">public</span> <span class="pl-k">int</span> <span class="pl-smi">Red</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC51" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">get</span> <span class="pl-k">=&gt;</span> <span class="pl-smi">redPin</span>.<span class="pl-smi">SoftPwmValue</span>;</td>
      </tr>
      <tr>
        <td id="L52" class="blob-num js-line-number" data-line-number="52"></td>
        <td id="LC52" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">set</span> <span class="pl-k">=&gt;</span> <span class="pl-smi">redPin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">=</span> <span class="pl-smi">value</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC55" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">public</span> <span class="pl-k">int</span> <span class="pl-smi">Green</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC57" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">get</span> <span class="pl-k">=&gt;</span> <span class="pl-smi">greenPin</span>.<span class="pl-smi">SoftPwmValue</span>;</td>
      </tr>
      <tr>
        <td id="L58" class="blob-num js-line-number" data-line-number="58"></td>
        <td id="LC58" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">set</span> <span class="pl-k">=&gt;</span> <span class="pl-smi">greenPin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">=</span> <span class="pl-smi">value</span>;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC61" class="blob-code blob-code-inner js-file-line">        <span class="pl-k">public</span> <span class="pl-k">int</span> <span class="pl-smi">Blue</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC63" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">get</span> <span class="pl-k">=&gt;</span> <span class="pl-smi">bluePin</span>.<span class="pl-smi">SoftPwmValue</span>;</td>
      </tr>
      <tr>
        <td id="L64" class="blob-num js-line-number" data-line-number="64"></td>
        <td id="LC64" class="blob-code blob-code-inner js-file-line">            <span class="pl-k">set</span> <span class="pl-k">=&gt;</span> <span class="pl-smi">bluePin</span>.<span class="pl-smi">SoftPwmValue</span> <span class="pl-k">=</span> <span class="pl-smi">value</span>;</td>
      </tr>
      <tr>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/robertsundstrom/IotCamera/blame/3a81c5527791fc081a13b71955903aaeca75433e/src/Components/RGBLed.cs">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.40270s from unicorn-7547b9967b-58k8m">GitHub</span>, Inc.</li>
