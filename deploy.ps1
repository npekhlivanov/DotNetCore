...
<html lang="en">
  ...
  <title>IotCamera/deploy.ps1 at master · robertsundstrom/IotCamera · GitHub</title>
  ...
  <meta name="request-id" content="1034:6FA1:1E4B870:3216C73:5BA41A29" data-pjax-transient>
  ...
  <meta name="octolytics-host" content="collector.githubapp.com" /><meta name="octolytics-app-id" content="github" /><meta name="octolytics-event-url" content="https://collector.githubapp.com/github-external/browser_event" /><meta name="octolytics-dimension-request_id" content="1034:6FA1:1E4B870:3216C73:5BA41A29" /><meta name="octolytics-dimension-region_edge" content="iad" /><meta name="octolytics-dimension-region_render" content="iad" />
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="">
  ...
  <meta name="octolytics-dimension-user_id" content="919580" /><meta name="octolytics-dimension-user_login" content="robertsundstrom" /><meta name="octolytics-dimension-repository_id" content="107713638" /><meta name="octolytics-dimension-repository_nwo" content="robertsundstrom/IotCamera" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="107713638" /><meta name="octolytics-dimension-repository_network_root_nwo" content="robertsundstrom/IotCamera" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/robertsundstrom/IotCamera/blob/master/deploy.ps1" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="107713638" data-scoped-search-url="/robertsundstrom/IotCamera/search" data-unscoped-search-url="/search" action="/robertsundstrom/IotCamera/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=M8DuaX54om8Tvs7H5DKR+v/rm8WvL7bD+fPQKsiZ3f64TuAjVew5L+lA31eokCeD239HLZ+hhIK8ws6f+H6whA=="
          spellcheck="false"
          autocomplete="off"
          >
          ...
          <a class="HeaderMenu-target text-white no-underline mr-3" href="/login?return_to=%2Frobertsundstrom%2FIotCamera%2Fblob%2Fmaster%2Fdeploy.ps1" data-ga-click="(Logged out) Header, clicked Sign in, text:sign-in; experiment:site_header_dropdowns; group:dropdowns">Sign&nbsp;in</a>
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/robertsundstrom/IotCamera/blob/3a81c5527791fc081a13b71955903aaeca75433e/deploy.ps1">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:b6973282a9bd7e539f7441d0bf27b2b9 -->

      <div class="signup-prompt-bg rounded-1">
      <div class="signup-prompt p-4 text-center mb-4 rounded-1">
        <div class="position-relative">
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/site/dismiss_signup_prompt" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="g3ghGC9yzi6EHpH4XBvL5Cv4dS/n0fvX7FKR9/M1W0VqkQcZ4T6qBfG2ikHAikz6OaAqKlx6fVdBQnl4mLcp/Q==" />
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open "
               href="/robertsundstrom/IotCamera/blob/develop/deploy.ps1"
               data-name="develop"
               data-skip-pjax="true"
               rel="nofollow">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/robertsundstrom/IotCamera/blob/master/deploy.ps1"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
    ...
    <div id="blob-path" class="breadcrumb">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/robertsundstrom/IotCamera"><span>IotCamera</span></a></span></span><span class="separator">/</span><strong class="final-path">deploy.ps1</strong>
    </div>
  </div>
  ...
  <div class="commit-tease">
      <span class="float-right">
        <a class="commit-tease-sha" href="/robertsundstrom/IotCamera/commit/2a25d7beafecfcc478bb73f01be47b1e9ed68009" data-pjax>
          2a25d7b
        </a>
        <relative-time datetime="2017-10-24T16:53:24Z">Oct 24, 2017</relative-time>
      </span>
      <div>
        ...
        <a class="user-mention" rel="author" data-hovercard-user-id="919580" data-octo-click="hovercard-link-click" data-octo-dimensions="link_type:self" href="/robertsundstrom">robertsundstrom</a>
          <a data-pjax="true" title="Built simple components for Button and LED." class="message" href="/robertsundstrom/IotCamera/commit/2a25d7beafecfcc478bb73f01be47b1e9ed68009">Built simple components for Button and LED.</a>
      </div>
...
<details class="details-reset details-overlay details-overlay-dark lh-default text-gray-dark float-left mr-2" id="blob_contributors_box">
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/robertsundstrom/IotCamera/raw/master/deploy.ps1">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/robertsundstrom/IotCamera/blame/master/deploy.ps1">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/robertsundstrom/IotCamera/commits/master/deploy.ps1">History</a>
    </div>
  ...
  <div itemprop="text" class="blob-wrapper data type-powershell">
      ...
      <tr>
        ...
        <td id="LC1" class="blob-code blob-code-inner js-file-line">dotnet publish <span class="pl-k">-</span>r linux<span class="pl-k">-</span>arm</td>
      </tr>
      <tr>
        <td id="L2" class="blob-num js-line-number" data-line-number="2"></td>
        <td id="LC2" class="blob-code blob-code-inner js-file-line">.<span class="pl-k">/</span>tools<span class="pl-k">/</span>sshdeploy monitor <span class="pl-k">-</span>s <span class="pl-s"><span class="pl-pds">&quot;</span>.\src\IotCamera\bin\Debug\netcoreapp2.0\linux-arm\publish<span class="pl-pds">&quot;</span></span> <span class="pl-k">-</span>t <span class="pl-s"><span class="pl-pds">&quot;</span>/home/pi/target<span class="pl-pds">&quot;</span></span> <span class="pl-k">-</span>h <span class="pl-c1">192.168</span>.<span class="pl-c1">1.39</span> <span class="pl-k">-</span>u pi <span class="pl-k">-</span>w <span class="pl-k">&lt;</span>password<span class="pl-k">&gt;</span></td>
      </tr>
</table>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/robertsundstrom/IotCamera/blame/3a81c5527791fc081a13b71955903aaeca75433e/deploy.ps1">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.14623s from unicorn-108566062-lxfbd">GitHub</span>, Inc.</li>
